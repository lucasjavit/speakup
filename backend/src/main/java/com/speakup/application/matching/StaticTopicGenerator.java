...
/**
 * Static implementation of TopicGeneratorStrategy.
 * Uses a predefined list of conversation topics.
 * This is the default implementation when no AI provider is configured.
 */
@Component
@ConditionalOnProperty(name = "speakup.topics.provider", havingValue = "static", matchIfMissing = true)
public class StaticTopicGenerator implements TopicGeneratorStrategy {
